...
app.http("health", {
  ...
  handler: async (request) => json(request, {
    ...
    routes: [
      ...
      "GET /api/staff/class-registrations",
      "POST /api/staff/classes",
      "PATCH /api/staff/classes/{id}",
      "PATCH /api/staff/applications/{id}",
      "GET /api/staff/jobs",
      "POST /api/staff/jobs",
      "PATCH /api/staff/jobs/{id}",
      "GET /api/staff/tasks",
      ...
      "GET /api/staff/enrolments",
      "PATCH /api/staff/enrolments/{id}",
